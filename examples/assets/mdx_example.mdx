...
Here's a [masked link](https://github.com/nerfstudio-project/rfviser). Not a fan?
Here's a normal one: https://pypi.org/project/rfviser/
...
| [Viser](https://nerfstudio-project.github.io/rfviser/) | An interactive 3D visualization toolbox for Python |
